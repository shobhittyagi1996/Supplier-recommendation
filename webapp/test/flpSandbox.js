		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Supplier Recommendation Application",
									"targetURL": "#kpocomsupplierrecommendation-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"kpocomsupplierrecommendation-display": {
								"semanticObject": "kpocomsupplierrecommendation",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=kpo.com.supplierrecommendation",
									"url": sap.ui.require.toUrl("kpo/com/supplierrecommendation")
								}
							}
						}
					}
